<template>
  <div
    class="w-full absolute right-0 h-full overflow-x-hidden transform translate-x-0"
  >
    <div
      class="2xl:w-4/12 bg-gray-50 h-screen overflow-y-auto p-8 absolute right-0"
    >
      <div class="w-full p-3 bg-white rounded shadow flex">
        <div
          tabindex="0"
      ...
      <span
        tabindex="0"
        class="focus:outline-none text-sm block leading-normal pt-8 border-b pb-2 border-gray-300 text-gray-600"
      >
        Messages Read
      </span>
      <div class="w-full p-3 mt-6 bg-white rounded shadow flex">
        <div
          tabindex="0"
